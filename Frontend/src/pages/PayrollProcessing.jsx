...
export default function PayrollProcessing() {
  return (
    <div className="relative flex flex-col w-full min-h-screen bg-background-light dark:bg-background-dark pb-24 shadow-2xl">
      ...
      <div className="flex gap-4 p-4 pt-0 overflow-x-auto no-scrollbar snap-x">
        <StatCard icon="payments" label="Total Payout" value="XAF 1.2M" className="min-w-[150px]" />
        <StatCard icon="group" label="Employees" value="450" className="min-w-[150px]" />
        <StatCard icon="account_balance_wallet" label="Deductions" value="XAF 320k" className="min-w-[150px]" />
      </div>
      ...
      <div className="flex flex-col gap-3 px-4 pb-4">
        ...
        <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-surface-light dark:bg-surface-dark shadow-sm border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-colors cursor-pointer group">
          ...
          <div className="flex flex-col items-end gap-1">
            <p className="text-text-main dark:text-white text-base font-bold tabular-nums">XAF 8,400.00</p>
        ...
        <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-surface-light dark:bg-surface-dark shadow-sm border-l-4 border-red-500 cursor-pointer group">
          ...
          <div className="flex flex-col items-end gap-1">
            <p className="text-text-main dark:text-white text-base font-bold tabular-nums">XAF 4,200.00</p>
        ...
        <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-surface-light dark:bg-surface-dark shadow-sm border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-colors cursor-pointer group">
          ...
          <div className="flex flex-col items-end gap-1">
            <p className="text-text-main dark:text-white text-base font-bold tabular-nums">XAF 6,150.00</p>
            <span className="inline-flex items-center rounded-md bg-green-50 dark:bg-green-900/20 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20">Ready</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-surface-light dark:bg-surface-dark shadow-sm border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-colors cursor-pointer group">
          ...
          <div className="flex flex-col items-end gap-1">
            <p className="text-text-main dark:text-white text-base font-bold tabular-nums">XAF 9,800.00</p>
            <span className="inline-flex items-center rounded-md bg-green-50 dark:bg-green-900/20 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20">Ready</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-surface-light dark:bg-surface-dark shadow-sm border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-colors cursor-pointer group">
          ...
          <div className="flex flex-col items-end gap-1">
            <p className="text-text-main dark:text-white text-base font-bold tabular-nums">XAF 5,300.00</p>
            <span className="inline-flex items-center rounded-md bg-green-50 dark:bg-green-900/20 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20">Ready</span>
          </div>
        </div>
      </div>
