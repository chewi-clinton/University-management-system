              ...
              <div className="flex justify-between items-start">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    <h1 className="text-white text-3xl font-bold tracking-tight">XAF 12,450.00</h1>
          ...
          <div>
            ...
            <div className="flex flex-col bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">
              ...
              <div className="flex items-center justify-between p-4">
                ...
                <span className="text-sm font-bold text-[#111418] dark:text-white">-XAF 5,000.00</span>
              </div>
              {/* Transaction Item 2 */}
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-[#111418] dark:text-white">XAF 150.00</span>
              </div>
              {/* Transaction Item 3 */}
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-[#111418] dark:text-white">-XAF 85.50</span>
              </div>
            </div>
          </div>
        </div>
