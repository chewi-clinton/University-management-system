...
export default function BusRegistration() {
  return (
    <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto bg-surface-light dark:bg-surface-dark shadow-xl">
      <TopBar
        title="Bus Services"
        right={
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[#111418] dark:text-white text-lg font-bold leading-tight">Not Registered</p>
                                  <p className="text-primary dark:text-white text-lg font-bold leading-tight">Not Registered</p>
                </div>
              </div>
        ...
        <div className="px-4 pt-2 pb-6">
          ...
          <div className="rounded-xl bg-background-light dark:bg-[#1a2632] p-4 border border-transparent dark:border-gray-700">
            <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
              ...
              <span className="text-primary dark:text-white font-medium">$150.00</span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-200 dark:border-gray-700">
              <span className="text-[#617589] dark:text-gray-400">Service Tax (3.3%)</span>
              <span className="text-primary dark:text-white font-medium">$5.00</span>
            </div>
            ...
            <label className="flex items-center justify-between p-3 border border-primary bg-primary/5 rounded-lg cursor-pointer transition-all">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-muted dark:text-gray-400 text-xs">Balance: $450.00</span>
                </div>
              </div>
