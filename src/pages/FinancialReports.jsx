        ...
        <main className="flex-1 flex flex-col gap-6 px-4 pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="col-span-1 md:col-span-3 bg-primary rounded-xl p-5 shadow-lg text-white relative overflow-hidden">
              ...
              <h2 className="text-3xl font-bold mb-2">$1,250,000.00</h2>
            ...
            <StatCard icon="arrow_downward" label="Total Income" value="$3,450,200" note="+8% Tuition Fees" />

            <StatCard icon="arrow_upward" label="Total Expenses" value="$2,200,200" note="+2% Payroll Increase" />
          </div>
