...
export default function Notifications() {
  return (
    <div className="bg-background-light dark:bg-background-dark text-primary dark:text-white overflow-x-hidden min-h-screen flex flex-col relative">
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-surface dark:bg-surface-dark border-t border-gray-100 dark:border-gray-800 pb-safe pt-2 px-6 pb-6 z-30">
        <div className="flex justify-between items-center max-w-lg mx-auto">
          <button className="flex flex-col items-center gap-1 text-muted hover:text-primary transition-colors">
