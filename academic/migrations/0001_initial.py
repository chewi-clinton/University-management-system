# Generated by Django 4.2.27 on 2025-12-25 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "platform",
                    models.CharField(
                        choices=[("zoom", "Zoom"), ("google_meet", "Google Meet")],
                        default="zoom",
                        max_length=50,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="created_zoom_classes",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["student_id"], name="student_cou_student_35c061_idx"
                    )
                ],
        ...
        migrations.AddIndex(
            model_name="student",
            index=models.Index(
                fields=["program_id"], name="students_program_cb6333_idx"
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("semester_number__gte", 1), ("semester_number__lte", 3)
                ),
        ...
        migrations.AddIndex(
            model_name="notice",
            index=models.Index(
                fields=["target_audience", "post_date"],
                name="notices_target__ea22f6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="grade",
            index=models.Index(
                fields=["student_id", "offering_id"], name="grades_student_3c6bef_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="enrollments_student_e8ccec_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student_id", "offering_id", "attendance_date"],
                name="attendance_student_439da5_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="attendance",
