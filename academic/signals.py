...
from .models import (
    ...
    Attendance, StudentCourseRegistration, Grade
)
...
def update_attendance_summary(sender, instance, created, **kwargs):
    ...
    # Simplified condition: always update on save
    ...
    summary.attendance_percentage = (attended_classes / total_classes * 100) if total_classes > 0 else 0
    ...
    if summary.attendance_percentage < 75 and not summary.warning_sent:
        ...
        # summary.warning_sent = True  # Uncomment when notification system is implemented
...
def update_enrollment_count(sender, instance, created, **kwargs):
    ...
    if created and instance.status == 'registered':
        ...
        offering.save()
    elif not created and 'withdrawn' in (getattr(instance, '_old_status', None), instance.status):
...
def update_student_gpa(sender, instance, created, **kwargs):
    ...
    if instance.is_finalized:
        ...
        if registrations.exists():
            ...
            student.current_gpa = total_points / total_credits if total_credits > 0 else None
            student.save()
