...
const Header = ({ onToggleSidebar, isSidebarCollapsed, user }) => {
  ...
  const notifications = [
    { id: 1, title: 'Exam Schedule Updated', time: '2 hours ago', unread: true },
    ...
    <header className={`header ${isSidebarCollapsed ? 'header--expanded' : ''}`}>
      ...
      <div className="header__right">
        ...
        <div className="header__notifications">
          ...
          >
            <Bell size={20} />
            <Badge variant="error" size="sm" className="header__notifications-badge">
              2
            </Badge>
          </Button>
              ...
              <div className="header__notifications-list">
                {notifications.map(notification => (
                  ...
                  >
                    ...
                    {notification.unread && <div className="notification__dot" />}
                  </div>
                ))}
              </div>
            </motion.div>
          ...
          {showProfileMenu && (
            ...
            >
              ...
              <div className="header__profile-menu">
                <Button variant="ghost" size="sm" className="header__profile-item">
                  <User size={16} />
                  <span>Profile</span>
                </Button>
                <Button variant="ghost" size="sm" className="header__profile-item">
